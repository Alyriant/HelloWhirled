...
/**
 * A too-simple trie for Strings, supporting add, containsPrefix, contains, and remove.
 * No Unicode support, only ASCII characters supported. No null checks.
 *
 * This implementation uses an ArrayList of Character for traversal, which is not terribly efficient.
 */
